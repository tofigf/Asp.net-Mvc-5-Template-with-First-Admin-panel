...
namespace EscanorHomeWork.Areas.Manage.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "Id,Holder,Position,Desc")] Feedback feedback)
        {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "Id,Holder,Position,Desc")] Feedback feedback)
        {
            if (ModelState.IsValid)
            {
